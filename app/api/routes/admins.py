...
def update_admin(admin_id: UUID, payload: AdminUpdate, db: Session = Depends(get_db), current_email: str = Depends(get_current_admin)):
    ...
    return admin_crud.update(db, db_obj=target, obj_in=payload)
