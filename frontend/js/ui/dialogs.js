(function () {
  ...
  const modalFooterActions = ({
    ...
    const dangerGroup = dangerLabel
      ...
      : '';
    return `${dangerGroup}<div class="modal-footer-group"><button type="button" class="btn btn-secondary" data-action="${secondaryAction}">${secondaryLabel}</button><button type="button" class="btn btn-primary" id="${primaryId}">${primaryLabel}</button></div>`;
  };
