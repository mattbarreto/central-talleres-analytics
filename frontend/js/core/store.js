...
export const state = {
    ...
    operationsBucket: '',
    operationsUnmanaged: false,
    operationsUnanswered: false,
    operationsPendingGroup: 'today',
    operationsPendingView: 'horizon',
    operationsPendingManagement: 'new',
    operationsContextCollapsed: false,
    operationsContextSections: {
        tomorrow: false,
        week: false,
    },
    operationsContextViewport: '',
    operationsContextInitialized: false,
    dashboardYear: '',
    dashboardStatus: '',
    dashboardWorkshop: '',
