        ...
        <div class="dash-container">
          ...
          ${UI.Section({
            ...
            content: `<div class="dash-kpis">
              ${UI.KpiCard({ id: 'c-total', label: 'Comunicaciones', value: String(summary.total || 0), delta: '0%', trend: 'Volumen' })}
              ${UI.KpiCard({ id: 'c-sent', label: 'Enviadas', value: String(summary.sent || 0), delta: '0%', trend: 'Entrega' })}
              ${UI.KpiCard({ id: 'c-failed', label: 'Fallidas', value: String(summary.failed || 0), delta: '0%', trend: 'Incidentes' })}
              ${UI.KpiCard({ id: 'c-rate', label: 'Entrega estimada', value: `${summary.deliveryRate || 0}%`, delta: '0%', trend: 'Calidad' })}
            </div>`
          })}
